...
const products = [
  {
    ...
    images: [
      {
        src: "src/images/products/fresh-fruit-mango1.jpg",
        alt: "Mango pulp"
      },{
        src: "src/images/products/fruit-pulp-mango.jpg",
        alt: "Mango pulp"
      },{
        src: "src/images/products/dried-fruit-lemons2.jpg",
  ...
  },
  {
    ...
    images: [
      {
        src: "src/images/products/dried-fruit-mango1.jpg",
        alt: "Dried mango slices"
      },
      {
        src: "src/images/products/dried-fruit-lemons.jpg",
        alt: "Dried lemons"
      },
      {
        src: "src/images/products/dried-fruit-rolls.jpg",
        alt: "Dried fruit rolls"
      },
      {
        src: "src/images/products/grenadilla.jpg",
  ...
  },
  {
    ...
    images: [
      ...
      {
        src: "src/images/products/fruit-pulp-mango2.jpg",
        alt: "Mango pulp products"
      },
      {
        src: "src/images/products/fruit-pulp-guava.jpg",
        alt: "Guava pulp"
      },
      {
        src: "src/images/products/fruit-pulp-guava2.jpg",
        alt: "Guava pulp products"
      },
      {
        src: "src/images/products/fresh-mangos.jpg",
...
const campsiteImages = [
  {
    src: "src/images/campsite/campsite1.jpg",
    alt: "Campsite view"
  },
  {
    src: "src/images/campsite/campsite2.jpg",
    alt: "Campsite facilities"
  },
  {
    src: "src/images/campsite/boating1.jpg",
    alt: "Boating view"
  },
  {
    src: "src/images/campsite/t1.jpg",
    alt: "Boating activities"
  },
  {
    src: "src/images/campsite/fishing.jpg",
    alt: "Fishing at the dam"
  },
  {
    src: "src/images/campsite/nature.jpg",
    alt: "Natural surroundings"
  },
  {
    src: "src/images/campsite/dogs-welcome.jpg",
